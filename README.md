...
- Remotion 原创合成音频与 EasyVoice 中文旁白：`public/audio/`
...
项目包含一个 1080 × 1920、18 秒的 Remotion 竖屏短片，用来介绍每日 GitHub 热榜、Top 3 项目、AI / Trading 观察和最终日报页。视频已加入本地合成的轻节奏音乐底、转场音效和 EasyVoice 生成的中文语音讲解。
